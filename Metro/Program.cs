...
namespace NetroRiyadh
{
    class Program
    {
        ...
        public static void stopsBetweenStations(string startLine, string startStation, string endLine, string endStation)
        {
            ...
            if (startLine ==  "Red") actualStartLine = Red;
            else if (startLine == "Blue")   actualStartLine = Blue;
            else if (startLine == "Green") actualStartLine = Green;

            if (endLine == "Red")    actualEndLine = Red;
            else if (endLine == "Blue")  actualEndLine = Blue;
            else if (endLine == "Green")   actualEndLine = Green;
